...
We'll start with creating a new site with a very basic template. Then we'll add in a few pages and posts. With ssmall variations on that, you will be able to create many different types of web sites.
